...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, COUNT(i.kitapno) AS count FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno WHERE o.sinif IN ('10A', '10B') GROUP BY o.sinif ORDER BY count DESC";
    ...
    String QUESTION_9 = "SELECT o.ad, o.soyad, COUNT(i.kitapno) AS count FROM ogrenci o INNER JOIN islem i ON o.ogrno = i.ogrno GROUP BY o.ad, o.soyad ORDER BY CASE WHEN o.ad = 'Deniz' THEN 0 ELSE 1 END, o.ad";
